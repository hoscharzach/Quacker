...
Revision ID: 2368b4d7d868
Revises: 
Create Date: 2022-09-15 23:50:15.787662
...
def upgrade():
    ...
    op.create_index('my_idx', 'posts', ['parent_id', 'created_at'], unique=False)
...
def downgrade():
    ...
    op.drop_index('my_idx', table_name='posts')
