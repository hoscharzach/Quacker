...
export default function SearchBar() {
    ...
    return (
        <>
            <div onClick={() => setShowMenu(true)} id="search-bar" data-focused={showMenu ? "1" : "0"}>
            ...
            {showMenu &&
                ...
                <div onBlur={() => setShowMenu(false)} className="search-dropdown" style={{ position: 'absolute', top: 45, height: 'auto', width: '370px', backgroundColor: 'rgba(21,32,43,1.00)' }}>
